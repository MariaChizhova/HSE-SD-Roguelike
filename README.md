...
### TrackerStrategy
Часть Model. Класс, реализующий интерфейс StrategyEnemy. Отслеживающее поведение врага. Следует туда, где в последний раз был замечен игрок.

### SearchingStrategy
Часть Model. Класс, реализующий интерфейс StrategyEnemy. Поведение врага, в котором он ищет игрока в окрестности последнего контакта игрока.
